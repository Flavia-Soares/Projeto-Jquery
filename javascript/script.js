...
$("#gestante").blur(function seGestante() {
  ...
  console.log("Esse " + optGestante.value);
...
$("#etnia").blur(function seGestante() {
...
$("#profissao").blur(function seGestante() {
...
$("#comorbidades").blur(function temComorbidade() {
  ...
  console.log(optComorbidade.value);
...
function escopo() {
  ...
  function resultadoDoForm(evento) {
    ...
    function printarTela() {
      ...
      function fase() {
        if (
          (idade > 18 && etnia == "indigena" && gestacao == false) ||
          prof == 1 ||
          idade >= 75
        ) {
          return "1";
